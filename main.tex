...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      {\textbf{{\href{https://github.com/olezhabobrov/Quoridor}{\underline{Implementation of board game Quoridor with bot}}}} $|$ \emph{C++, Qt}}{}
      \resumeItemListStart
        \resumeItem{Developed GUI board game Quoridor for 2 players}
      ...
      \resumeProjectHeading
          {\textbf{{\href{https://github.com/Code-team-open-source/Code-team}{\underline{Cooperative party game}}}} $|$ \emph{C++, Qt, winsock} }{}
          \resumeItemListStart
            \resumeItem{Created Code-team as a part of University course in the team of 3 students}
            \resumeItem{Code-team is local cooperative multiplayer game challenging peoples' reaction and communication}
            \resumeItem{Designed and implemented the game architecture and logic between server and players using thread safe queues}
          \resumeItemListEnd
         \vspace{-13pt}
