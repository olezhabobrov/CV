...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      {\textbf{Software analysis intern at Huawei} $|$ \emph{C++, KLEE, gRPC}
      }{Feb. 2022 -- June 2022}
      \resumeItemListStart
        \resumeItem{Developed a static code analyzer for C/C++ based on KLEE (symbolic execution engine) }
...
\section{Projects}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Wrote projects using Object-oriented programming, templates, threads}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \large{\item{
     \textbf{Languages}{: Java, Kotlin, C++, C, Python} \\
     \textbf{Technologies/Frameworks}{: Qt, SQL, KLEE, Git, CMake, \LaTeX} \\
    }}
 \end{itemize}
 \vspace{-16pt}
